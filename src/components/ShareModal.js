        ...
        >
          ...
          <div className="p-4 border-t border-gray-200 dark:border-gray-700">
            <textarea
              ...
              className="w-full px-4 py-3 bg-gray-100 dark:bg-gray-700 border-0 rounded-xl text-gray-900 dark:text-white placeholder-gray-500 focus:ring-2 focus:ring-blue-500 resize-none"
              rows="3"
            />
          </div>
